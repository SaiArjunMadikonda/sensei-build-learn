        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <nav className="flex flex-col gap-2.5 text-sm text-muted-foreground">
              ...
              <Link to="/waitlist" className="hover:text-primary transition-colors">Join Waitlist</Link>
            </nav>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a key={s.label} href="#" className="flex h-9 w-9 items-center justify-center rounded-xl bg-muted text-muted-foreground hover:bg-accent hover:text-primary transition-colors" aria-label={s.label}>
